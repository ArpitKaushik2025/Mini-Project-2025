...
function NewQuestion() {
	return (
		<div className="min-h-screen flex flex-col">
			...
			<div className="flex-1 grid grid-cols-3 grid-rows-1 gap-1 px-12 py-12 backdrop-blur-2xl bg-gradient-to-r from-[#A9F1DF] to-[#FFBBBB] dark:bg-[gradient-to-r dark:from-[#1d1d2c]">
				{/* Left Pane */}
						...
						<form className="max-w-md mx-auto">
							<div className="mb-5">
								...
								<input
									...
									className="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-md rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-[#1d1d2c] dark:border-green-500"
              ...
              Also need some logic here to format the user input in a certain way to ensure consistency. */}
							...
							<div>
								...
								<input
									...
									className="bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-md rounded-lg focus:ring-red-500 dark:bg-[#1d1d2c] focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500"
									placeholder="Enter Something Suitable..."
								/>
				...
				<div className="options-form-fields size-auto col-span-2 ">
					...
					<div className="options grid grid-cols-2 mt-4 text-center gap-x-8 gap-y-12 p-8">
						{/* Option - 1 */}
						{/* <div className="option-1 outline-double m-auto rounded-xl w-[80%] p-8 bg-gradient-to-br from-[#E6A96D] to-[#EBEA6A] dark:bg-gradient-to-r dark:from-[#C08497] dark:to-[#F2D7D9] "> */}
						<div className="option-1 outline-double m-auto rounded-xl w-[80%] p-8 liquid-glass">
							<input
								type="text"
								name="question"
								id="question"
						...
						{/* Option - 2 */}
						<div className="option-2 liquid-glass outline-double rounded-xl m-auto w-[80%] p-8">
							<input
								type="text"
								name="question"
								id="question"
						...
						{/* Option - 3 */}
						<div className="option-3 liquid-glass outline-double rounded-xl m-auto w-[80%] p-8">
							<input
								type="text"
								name="question"
								id="question"
							...
							<label className="inline-flex items-center mb-5 cursor-pointer gap-5 mt-5 mb-0">
								<input type="checkbox" value="" className="sr-only peer" />
								<div className="relative w-11 h-6 outline-1 outline-gray-400 bg-gray-200 peer-focus:outline-none peer-focus:ring-1 peer-focus:ring-red-300 dark:peer-focus:ring-red-500 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600 dark:peer-checked:bg-emerald-500"></div>
								<span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
									Correct Answer?
								</span>
							</label>
						...
						{/* Option - 4 */}
						<div className="option-4 liquid-glass outline-double rounded-xl m-auto w-[80%] p-8">
							<input
								type="text"
								name="question"
								id="question"
